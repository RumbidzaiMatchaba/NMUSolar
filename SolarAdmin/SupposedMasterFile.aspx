<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupposedMasterFile.aspx.cs" Inherits="NMUSolar.SolarAdmin.SupposedMasterFile" %>
...
<body>
    <form id="form1" runat="server">
       ...
       <div id="sessionUsername">
           <asp:Label runat="server" ID="lblsession" Text="kdjvbjdbv"></asp:Label>
       </div>
        <div class="content">
            <h1>User Settings</h1>
            <p> bjshbdjhsj blah
           ...
           <div id="content-table">
               ...
               <asp:Button ID="Button1" OnClick="btnChangeAdmin" OnClientClick="btnChangeAdmin" runat="server" Text="Change Administrator" />
